  ...
  return (
    <div className="main-page">
      ...
      <section className="main-hero">
        <div className="container hero-grid">
          <motion.div
            ...
            className="hero-text"
          >
            <span className="badge">Referência em Recuperação</span>
            <h1 className="hero-title">Resgate a vida de quem você ama com dignidade e excelência</h1>
            <p className="hero-desc">Tratamento humanizado, equipe multidisciplinar e infraestrutura de alto padrão para dependência química e saúde mental.</p>
            ...
            <div className="hero-insurances">
              ...
              <div className="insurances-grid-mini">
                {INSURANCE_LOGOS.map((logo, idx) => (
                  <img key={idx} src={logo} alt="Convênio Médico Aceito" title="Aceitamos este plano" loading="lazy" />
                ))}
              </div>
            </div>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Abordagem clínica e terapêutica para álcool e drogas com foco na ressocialização.",
                icon: <Stethoscope size={32} />
              },
              {
                title: "Saúde Mental",
                desc: "Tratamento para depressão, ansiedade, bipolaridade e outros transtornos.",
                icon: <Users size={32} />
              },
              {
                title: "Internação Involuntária",
                desc: "Suporte legal e humanizado para casos críticos onde o paciente corre risco.",
      ...
      <section id="metodologia" className="steps-section">
        <div className="container">
          <div className="steps-container glass">
            <h2>Passo a Passo da Recuperação</h2>
            <div className="steps-grid">
              {[
                { step: "01", title: "Triagem", text: "Avaliação inicial com equipe médica e psiquiátrica." },
                { step: "02", title: "Desintoxicação", text: "Processo assistido para estabilização física e mental." },
                { step: "03", title: "Terapia", text: "Dinâmicas em grupo e individuais com psicólogos." },
                { step: "04", title: "Ressocialização", text: "Preparação gradual para o retorno ao convívio social." }
              ].map((s, idx) => (
        ...
        <div className="container text-center">
          ...
          <div className="structure-gallery">
            <div className="gallery-main">
              <img src="https://clinicasgoiasbrasil.com.br/wp-content/uploads/2024/11/Unidade-1-10.jpeg" alt="Clínica" />
            </div>
            <div className="gallery-side">
              <img src="https://clinicasgoiasbrasil.com.br/wp-content/uploads/2024/11/Unidade-5-10.jpeg" alt="Área Externa" />
              <img src="https://clinicasgoiasbrasil.com.br/wp-content/uploads/2024/11/Unidade-4-10.jpeg" alt="Quartos" />
            </div>
          </div>
      ...
      <section className="final-cta">
        <div className="container text-center">
          <h2>Não espere o pior acontecer</h2>
          <p>A ajuda que você precisa está a um clique de distância.</p>
