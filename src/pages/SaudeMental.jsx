      ...
      <section className="main-hero">
        <div className="container hero-grid">
          <motion.div
            ...
            className="hero-text"
          >
            <span className="badge">Apoio Psiquiátrico</span>
            <h1 className="hero-title">Recupere a estabilidade com Apoio Especializado</h1>
            <p className="hero-desc">Tratamento compassivo e integrado para depressão, ansiedade e outros transtornos de saúde mental. Acompanhamento 24h.</p>
